...
class Test_Mancala(unittest.TestCase):
    ...
    def test_forecast_move(self):
        mancala = Mancala(Human_Player(), Human_Player(), starting_stones=3, starting_holes=6,verbose=True)
        mancala.reset()
        forecast = mancala.forecast_move(2)
        self.assertEqual(mancala.p1_holes, [3, 3, 3, 3, 3, 3])
        self.assertEqual(mancala.p2_holes, [3, 3, 3, 3, 3, 3])
        self.assertEqual(mancala.p1_mancala, 0)
        self.assertEqual(mancala.p2_mancala, 0)
        self.assertEqual(mancala.turn, 1)
        self.assertEqual(forecast.p1_holes, [4, 4, 0, 3, 3, 3])
        self.assertEqual(forecast.p2_holes, [3, 3, 3, 3, 3, 3])
        self.assertEqual(forecast.p1_mancala, 1)
        self.assertEqual(forecast.p2_mancala, 0)
        self.assertEqual(forecast.turn, 1)
        mancala.reset()
        forecast = mancala.forecast_move(3)
        self.assertEqual(mancala.p1_holes, [3, 3, 3, 3, 3, 3])
        self.assertEqual(mancala.p2_holes, [3, 3, 3, 3, 3, 3])
        self.assertEqual(mancala.p1_mancala, 0)
        self.assertEqual(mancala.p2_mancala, 0)
        self.assertEqual(mancala.turn, 1)
        self.assertEqual(forecast.p1_holes, [4, 4, 4, 0, 3, 3])
        self.assertEqual(forecast.p2_holes, [3, 3, 3, 3, 3, 3])
        self.assertEqual(forecast.p1_mancala, 0)
        self.assertEqual(forecast.p2_mancala, 0)
        self.assertEqual(forecast.turn, 2)
